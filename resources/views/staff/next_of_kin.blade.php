        ...
        <div class="w-full flex flex-col bg-transparent">
            <div class="flex items-center justify-between">
                ...
                <div class="w-2/3 sm:w-full">
                    <h5 class="font-normal font-sans flex space-y-2 justify-end m-0 uppercase">Add Staff Record</h5>
                </div>
            </div>
            <div>
                <form type="post" accept-charset="" action="" class="lg:gap-x-8 gap-x-2 flex w-full py-4">
                    ...
                    <div class="w-full lg:w-2/3 px-4 py-2 bg-brown-50 border border-brown-100 rounded-lg">
                        <div class="flex flex-col items-start border-b border-b-brown-100">
                            <h2 class="font-alkalami text-lg font-semibold mb-0 text-slate-600">Promotions</h2>
                            <p class="font-sans font-normal text-md text-slate-500 m-0">Staff record of promotions</p>
                        </div>
                                ...
                                <div class="w-full">
                                    <div id="cloneable" class="w-full relative mb-3">
                                        <div class="mb-3 w-full lg:flex lg:space-x-4 space-x-2">
                                            <div class="w-full">
                                                <label class="cloneableInstitutionTypeLabel font-semibold font-sans text-sm text-slate-800">Next of Kin Name</label>
                                                <div class="relative">
                                                    <input type="text" class="w-full pl-3 pr-10 py-2 bg-gray-50 placeholder:text-slate-400 text-slate-600 text-sm border border-gray-200 rounded-md transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 focus:shadow" name="nok-name[]" placeholder="NOK Name" value="" />
                                        ...
                                        <div class="mb-3 w-full lg:flex lg:space-x-4 space-x-2">
                                            <div class="w-full">
                                                <label class="cloneableInstitutionTypeLabel font-semibold font-sans text-sm text-slate-800">Relationship</label>
                                                <div class="relative">
                                                    <select class="w-full bg-gray-50 placeholder:text-slate-400 text-slate-600 text-sm border border-gray-200 rounded pl-3 pr-8 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow-md appearance-none cursor-pointer" name="nok-relationship[]">
                                        ...
                                        <div class="mb-3 w-full lg:flex lg:space-x-4 space-x-2">
                                            <div class="w-full min-w-max">
                                                <label class="font-semibold font-sans text-sm text-slate-800">Address of Next of Kin</label>
                                                <div class="relative">
                                                    <input type="text" class="w-full pl-3 pr-10 py-2 bg-gray-50 placeholder:text-slate-400 text-slate-600 text-sm border border-gray-200 rounded-md transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 focus:shadow" name="nok-address[]" placeholder="NOK Address" value="" />
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" width="24" height="24" stroke-width="2" class="absolute w-5 h-5 top-2.5 right-2.5 text-slate-400">
                                                        <path d="M9 18l3 3l3 -3"></path>
                                                        <path d="M12 15v6"></path>
                                                        <path d="M15 6l-3 -3l-3 3"></path>
                                            ...
                                            <div class="w-full min-w-max">
                                                ...
                                                <div class="relative">
                                                    <input type="text" class="w-full pl-3 pr-10 py-2 bg-gray-50 placeholder:text-slate-400 text-slate-600 text-sm border border-gray-200 rounded-md transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 focus:shadow" name="nok-phone[]" placeholder="NOK Phone Number" value="" />
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" width="24" height="24" stroke-width="2" class="absolute w-5 h-5 top-2.5 right-2.5 text-slate-400">
                                                        <path d="M9 18l3 3l3 -3"></path>
                                                        <path d="M12 15v6"></path>
                                                        <path d="M15 6l-3 -3l-3 3"></path>
